...
CLASS_DICT = {
    "electric_grid": GridDistributionLine,
    "mini-grids (points)": MiniGrid,
    "centroids_buildings_20km": Building,
    "polygons_buildings_20km": Building,
}
...
def clean_mini_grids(gdf: gpd.GeoDataFrame) -> gpd.GeoDataFrame:
    ...
    gdf_clean["status"] = MinigridStatus.known_to_exist.value
